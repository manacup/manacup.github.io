...
function renderFormTrobada(trobada) {
  ...
  <form id="trobadaForm">
    ...
    if (jugadorDesat[i][ronda] === ronda1) {
      return  jugadorDesat.partides.filter((p) => p.Ronda == ronda1)[0].Jugador2 
    }
  }
  return ; // Cap objecte té aquest valor per la clau especificada
            ...
            <div class="card-body">    
              ...
              <div class="row">
                <div class="col-10 mb-3">He pactat la ronda amb el meu adversari <span id="adv2">${
                  for (let i = 0; i < array.length; i++) {
    if (jugadorDesat[i][ronda] === ronda2) {
      return  jugadorDesat.partides.filter((p) => p.Ronda == ronda1)[0].Jugador2 
    }
  }
  return ; // Cap objecte té aquest valor per la clau especificada
