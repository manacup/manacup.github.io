function renderUserCard(jugadorDesat) {
   if(jugadorDesat.Nom=="Antoni Llull" || jugadorDesat.Nom=="Antoni Riera" )
    { 
...
function renderAparellaments(partida) {
  const aparellamentsTemplate = `
    ...
    partida.Estat
              ...
              <div class="card-body">
                  <div class="row">
                      <div class="row">
                          <div class="d-flex align-items-center">
                              <div class="h6  flex-grow-1 row col-8">
                                <span  class="nom ${
                                  partida.resultats[0].Punts_1 +
                                    partida.resultats[1].Punts_1 ==
                                    2 ||
                              ...
                              <small class="text-primary  text-end ${
                                ...
                                partida.resultats[0].Puntuacio_2
                                  ? "fw-bold"
                                  : ""
                              }">${partida.resultats[0].Puntuacio_1}</small>
                              <small class="text-primary  text-end ${
                                partida.resultats[1].Puntuacio_1 >
                                partida.resultats[0].Puntuacio_2
                                  ? "fw-bold"
                                  : ""
                              }">|${partida.resultats[1].Puntuacio_1}</small>
                          </div>
                          <div class="d-flex align-items-center">
                              ...
                              <small class="text-primary ${
                                ...
                                partida.resultats[0].Puntuacio_1
                                  ? "fw-bold"
                                  : ""
                              }">${partida.resultats[0].Puntuacio_2}</small>
                              <small class="text-primary ${
                                partida.resultats[1].Puntuacio_2 >
                                partida.resultats[1].Puntuacio_1
                                  ? "fw-bold"
                                  : ""
                              }">|${partida.resultats[1].Puntuacio_2}</small>
                          </div>
                      </div>
                  </div>
              </div>
    ...
    `;
  let pajugada =
    partida.resultats[0].Puntuacio_1 + partida.resultats[0].Puntuacio_2 > 0;
  let sajugada =
    partida.resultats[1].Puntuacio_1 + partida.resultats[1].Puntuacio_2 > 0;
  let pdajugada = pajugada && sajugada;

  const aparellamentsTemplateXampions = `
    <div class="p-1 entrada">
      <div class="card
      ${pdajugada ? "" : "detallpartida"}" data-id="${
    pdajugada
      ? ""
      : pajugada
                          ...
                          <div class=" row col-6">
                            ...
                            <span  class="h6 nom ${
                              ...
                              partida.resultats[0].Puntuacio_2 +
                                ...
                                ? "fw-bold"
                                : "fw-normal"
                            }">${partida.Jugador2}</span>
                          </div>
                          <div class="row col detallpartida" data-id="${
                            partida.resultats[0].ID
                          }" data-estat="${partida.resultats[0].Estat}">
                          <span class="text-primary  text-end ${
                            partida.resultats[0].Puntuacio_1 >
                            partida.resultats[0].Puntuacio_2
                              ? "fw-bold"
                              : ""
                          }">${partida.resultats[0].Puntuacio_1}</span>
                          <span class="text-primary  text-end ${
                            partida.resultats[0].Puntuacio_2 >
                            partida.resultats[0].Puntuacio_1
                              ? "fw-bold"
