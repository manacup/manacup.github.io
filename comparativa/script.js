...
<li class="list-group-item d-flex  align-items-center active campionat" data-camp="${partida.campionat.replace(
        /\s/g,
        ""
      )}" onclick="collapse(this.dataset.camp)">${partida.campionat}</li>
`;
...
<li class="list-group-item d-flex align-items-center partida ${
      partida.puntsJugador > partida.puntsAdversari
        ? "list-group-item-success"
        : "list-group-item-danger"
    }" data-bs-toggle="modal" data-bs-target="#partidaModal" onclick="recuperaPartida('${
      partida.campionat
    }',${partida.row})" data-camp="${partida.campionat.replace(/\s/g, "")}">${
      partida.jugador
    } (${partida.puntsJugador}-${partida.puntsAdversari}) ${
      partida.adversari
    }</li>
`;
    ...
    var sel = selectAdversari.querySelector(
      "option[value='" + partida.adversari + "']"
    );
...
function mostraestadistica() {
  ...
  var victories = 0;
  var campionats = 0;
  var adversarisfiltrats = [
    ...new Set(partidesFiltrades.map((ad) => ad.adversari)),
  ].map((ad) => ad);
  ...
  text.innerHTML += `<li class="list-group-item d-flex align-items-center">Percentatge de victòries: ${(
    (victories / totalPartides) *
    100
  ).toFixed(2)}%</li>`;
  ...
  text.innerHTML += `<li class="list-group-item d-flex align-items-center">Diferencial: ${
          ...
          <div class="text-center position-relative">
            ...
            <div class="d-flex justify-content-center mb-4">
              <div class="col align-items-start">
                ...
                <div class="d-flex flex-column align-items-center">
                  <div class="card m-2 p-2 w-75 bg-primary bg-opacity-25 rounded-4 ${
                    !partida.Puntsmot_1 ? "d-none" : ""
                  }">
                    <small>Millor jugada</small>
                    <h6 class="m-2 mot">${
                      partida.Mot_1 ? partida.Mot_1.toUpperCase() : ""
                    }</h6>
              ...
              <div class="col align-items-end">
                ...
                <div class="d-flex flex-column align-items-center">
                  <div class="card m-2 p-2 w-75 bg-primary bg-opacity-25 rounded-4 ${
                    !partida.Puntsmot_2 ? "d-none" : ""
                  }">
                    <small>Millor jugada</small>
                    <h6 class="m-2 mot">${
                      partida.Mot_2 ? partida.Mot_2.toUpperCase() : ""
                    }</h6>
          ...
          <div class="carousel-inner" >
            <div class="carousel-item active quadrat">
              ...
              <div class="carousel-caption d-none d-md-block">
                <a href = "${partida.Full || ""}" target="_blank">URL full</a>        
              </div>
            </div>
            <div class="carousel-item quadrat">
              ...
              <div class="carousel-caption d-none d-md-block">
                <a href = "${partida.Tauler || ""}" target="_blank">URL tauler</a>        
              </div>
            </div>
